...
import { useNavigate} from "react-router-dom";
 ...
 export function Landing(){
  ...
  <span className="sm:text-5xl text-3xl self-center text-white font-sans font-bold">Simplify Your Daily Tasks</span>
   <span className="m-5 text-gray-400 self-center font-sans pt-5">Focus on what matters most , the minimalist task manager designed fro everyday productivity. </span>
   <div onClick={()=>{
     nav("/auth")
